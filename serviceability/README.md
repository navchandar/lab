...
# 🗺️ Serviceability Map
Visualize e-commerce delivery availability across 19,000+ Indian pincodes. Compare logistics coverage for major platforms using an interactive heatmap.

[https://navchandar.github.io/lab/serviceability/](https://navchandar.github.io/lab/serviceability/)


## Features
- Interactive Heatmap: Visualize "Out of Delivery Areas" (ODA) and serviceable zones instantly.
- Multi-Partner Comparison: Switch between Amazon, Flipkart, Zepto, Blinkit, and more.
- Performance: Uses pre-rendered transparent overlays 


## How It Works
Rendering 19,000+ geometric points in a browser can cause significant lag. This project solves that by offloading the rendering to the backend:

 - Python & GeoPandas map lat/long coordinates to Indian District boundaries.
 - Matplotlib generates high-resolution, transparent PNG overlays for each service.
 - Leaflet.js acts as a lightweight viewer, simply placing the pre-rendered image over the map tiles.
...
## Tech Stack
 ...
 - Data Sources: India Post (Pincodes)
